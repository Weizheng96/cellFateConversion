...
%% can't detect weak cell connected to strong cell
...
parfor t=1:T
    disp("channel 1: "+t+"/"+T);
    diffIntMap(:,:,:,t,1) = synquant_intensityDiff(dat(:,:,:,t,1),BgThr1,minSz, maxSz,smoothingfactor);
end
parfor t=1:T
    disp("channel 2: "+t+"/"+T);
    diffIntMap(:,:,:,t,2) = synquant_intensityDiff(dat(:,:,:,t,2),BgThr2,minSz, maxSz,smoothingfactor);
end
